...
// Description:This file is implements the apb write sequence
// Date       :04/03/2026
//
//***************************************//
...
// declaring handle transaction for request,response and factory refistraction   
   ...
   `uvm_object_utils_begin(apb_write_seq)
...
// constructor for the apb write seq   
   function new(string name="apb_write_seq");
      super.new(name);
   endfunction:new

// main task for the write sequence execution   
   task body();
